            ...
            <div class="admin-content">
                ...
                <?php elseif ($action === 'edit' && isset($data['invoice'])): ?>
                    ...
                    <div class="breadcrumb">
                        <a href="index.php?page=admin_invoices">Invoices</a>
                        <span>/</span>
                        <span class="current">Edit Invoice</span>
                    </div>
                    
                    <div class="form-card">
                        <h3>Edit Invoice</h3>
                        <form action="index.php?page=admin_invoices" method="POST">
                            <input type="hidden" name="form_action" value="update_invoice_status">
                                    ...
                                    <?php if (!empty($data['invoices'])): ?>
                                        <?php foreach ($data['invoices'] as $invoice): ?>
                                            <tr>
                                                ...
                                                <td>$<?php echo number_format((float)($invoice['amount_due'] ?? 0), 2); ?></td>
