            ...
            <div class="admin-content">
                ...
                <?php if ($action === 'add'): ?>
                    ...
                    <div class="breadcrumb">
                        <a href="index.php?page=manager_fees">Invoices</a>
                        <span>/</span>
                    ...
                    <div class="form-card">
                        ...
                        <form action="index.php?page=manager_fees" method="POST">
                            ...
                            <div class="form-actions">
                                ...
                                <a href="index.php?page=manager_fees" class="btn btn-secondary">Cancel</a>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="form-card">
                        ...
                        <form action="index.php?page=manager_fees" method="POST">
                            ...
                            <div class="form-actions">
                                ...
                                <a href="index.php?page=manager_fees&action=view&id=<?php echo (int)$data['invoice']['id']; ?>" class="btn btn-secondary">Cancel</a>
                            </div>
                        </form>
                    </div>
                ...
                <?php elseif ($action === 'view' && isset($data['invoice'])): ?>
                    ...
                    <div class="detail-card" style="margin-bottom: 20px;">
                        ...
                        <div class="form-actions">
                            <a href="index.php?page=manager_fees&action=edit&id=<?php echo (int)$data['invoice']['id']; ?>" class="btn btn-primary">Edit Invoice</a>
                            <a href="index.php?page=manager_fees" class="btn btn-secondary">Back to List</a>
                        </div>
                    </div>
                ...
                <?php else: ?>
                    ...
                    <div class="page-header">
                        <h2>All Invoices</h2>
                        <a href="index.php?page=manager_fees&action=add" class="btn btn-primary">Generate New Invoice</a>
                    </div>
                    ...
                    <div class="filter-bar">
                        <div class="filter-form">
                            ...
                            <select id="statusFilter" class="form-control" data-filter-table="invoicesTable" data-filter-column="7">
                                            ...
                                            <tr data-id="<?php echo (int)$invoice['id']; ?>">
                                                ...
                                                <td>
                                                    <div class="action-btns">
                                                        <a href="index.php?page=manager_fees&action=view&id=<?php echo (int)$invoice['id']; ?>" class="btn btn-sm btn-secondary">View</a>
                                                        <a href="index.php?page=manager_fees&action=edit&id=<?php echo (int)$invoice['id']; ?>" class="btn btn-sm btn-primary">Edit</a>
                                                        <form method="POST" action="index.php?page=manager_fees" style="display:inline;" onsubmit="return confirm('Are you sure you want to delete this invoice?');">
